...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    Page<Product> findByProductNameContainingAndCategoryList_CategoryId(@RequestParam("productName") String productName,
            @RequestParam("categoryId") int categoryId, Pageable pageable);
